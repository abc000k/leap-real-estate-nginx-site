...
一个纯 HTML + CSS + JavaScript 的公司展示官网，用 Nginx 提供静态文件服务，并将 `/api` 反向代理到 GitHub 公共 API。

## 功能

- LEAP 粉色视觉 Hero、Slogan 打字机效果、三项服务卡片、团队与联系方式。
- 纯 JavaScript 明暗主题切换、服务详情弹窗、实时 API 数据展示。
...
```bash
curl http://localhost:8080/api/repos/octocat/Hello-World
```
